...
Purpose:
    Creates views for the Gold layer of the data warehouse.
    The Gold layer represents the final business-ready star schema
...
Usage:
    These views are intended for direct consumption by
    reporting, dashboards, and analytical queries.
===============================================================================
*/
...
LEFT JOIN silver.erp_cust_loc_a101 cl
