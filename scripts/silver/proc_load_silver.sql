...
====================================================================================
Script Purpose:
  This stored procedure performs the ETL (Extract, Transform, Load) process to populate the 'silver' schema table from the 'bronze' scheama.
  Actions Performed:
  - Truncates the silver tables before loading data.
  - Inserts transformed and cleansed date from the bronze schema into the silver schema tables.
...
BEGIN
	...
	BEGIN TRY
		...
		INSERT INTO silver.crm_cust_info (cst_id, cst_key, cst_firstname, cst_lastname, cst_marital_status,cst_gndr, cst_create_date)
			SELECT 
				...
				CASE WHEN UPPER(TRIM(cst_marital_status)) = 'M' THEN 'Married'
					 ...
					 ELSE 'n/a' 
				END cst_marital_status, -- Normalize marital status values to readable format and handle missing values
		...
		INSERT INTO silver.erp_cust_loc_a101 (cid, country)
